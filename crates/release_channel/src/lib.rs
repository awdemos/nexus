...
pub fn app_identifier() -> &'static str {
    match *RELEASE_CHANNEL {
        ReleaseChannel::Dev => "Nexus-Editor-Dev",
        ReleaseChannel::Nightly => "Nexus-Editor-Nightly",
        ReleaseChannel::Preview => "Nexus-Editor-Preview",
        ReleaseChannel::Stable => "Nexus-Editor-Stable",
    }
}
...
impl ReleaseChannel {
    ...
    pub fn display_name(&self) -> &'static str {
        match self {
            ReleaseChannel::Dev => "Nexus Dev",
            ReleaseChannel::Nightly => "Nexus Nightly",
            ReleaseChannel::Preview => "Nexus Preview",
            ReleaseChannel::Stable => "Nexus",
        }
    }
    ...
    pub fn app_id(&self) -> &'static str {
        match self {
            ReleaseChannel::Dev => "dev.nexus.Nexus-Dev",
            ReleaseChannel::Nightly => "dev.nexus.Nexus-Nightly",
            ReleaseChannel::Preview => "dev.nexus.Nexus-Preview",
            ReleaseChannel::Stable => "dev.nexus.Nexus",
        }
    }
